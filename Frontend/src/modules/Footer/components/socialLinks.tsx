    ...
    <ul>
        <li>
            <a id="Facebook" href="#">
                ...
                <path fill="#D7DCDF" d="M352 32H288c-70.7 0-112 41.3-112 116v60H128v96h48v176h104V304h69.3l10.7-96H280v-48
        ...
        <li>
            <a id="Instagram" href="#">
                ...
                <rect x="3" y="3" width="18" height="18" rx="5" stroke="#D7DCDF" stroke-width="2"/>
                <circle cx="12" cy="12" r="4" stroke="#D7DCDF" stroke-width="2"/>
                <circle cx="17" cy="7" r="1.5" fill="#D7DCDF"/>
                </svg>
            </a>
        </li>
        ...
        <li>
            <a id="Twiter" href="#">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#D7DCDF" xmlns="http://www.w3.org/2000/svg">
